...
from handoff_release_check import CHECK_SCHEMA, _production_result_schema_snapshot, check_handoff_release  # noqa: E402
...
class HandoffReleaseCheckContractTest(unittest.TestCase):
    ...
    def test_require_schema_snapshot_returns_failure_without_claiming_release_ready(self) -> None:
        with tempfile.TemporaryDirectory() as temporary:
            ...
            self.assertFalse(report["schema_snapshot_ready"])
