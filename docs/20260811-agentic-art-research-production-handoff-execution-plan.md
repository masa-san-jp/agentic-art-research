...
- [x] (2026-08-14 JST) `HANDOFF-REFERENCE-CONTRACT-001`: Production Issue #35/#37対応として、source-ref indexの`references`/`record_hash`出力契約を固定。Research全120 testとvalidatorが合格。Production側の受入PRとは別commitで公開する。
